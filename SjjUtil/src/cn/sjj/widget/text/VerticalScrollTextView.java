...
import cn.sjj.bean.Sentence;

/**
 * @guide
 * <div>VerticalScrollTextView mSampleView = (VerticalScrollTextView) findViewById(R.id.sampleView1);<br>
		List lst=new ArrayList<Sentence>();<br>
		for(int i=0;i<30;i++){<br>
			if(i%2==0){<br>
				Sentence sen=new Sentence(i,i+"、金球奖三甲揭晓 C罗梅西哈维入围 ");<br>
				lst.add(i, sen);<br>
			}else{<br>
				Sentence sen=new Sentence(i,i+"、公牛欲用三大主力换魔兽？？？？");<br>
				lst.add(i, sen);<br>
			}<br>
		}	<br>
		//给View传递数据<br>
		mSampleView.setList(lst);<br>
		//更新View<br>
		mSampleView.updateUI();		</div>
 * @author xushilin
 * @url http://www.cnblogs.com/vaiyanzi/archive/2011/12/06/2277791.html
 */
