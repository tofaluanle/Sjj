...
/**
 * 
 * @author http://www.eoeandroid.com/forum.php?mod=viewthread&tid=157999
 * @date 2014-9-16 上午11:18:46
 */
public class TextViewVertical extends View {
	...
	private void GetTextInfo() {
		...
		if (mLineWidth == 0) {
			...
			paint.getTextWidths("a", widths);// 获取单个汉字的宽度
		...
		mRealLine++;// 额外增加一行
		mTextWidth = mLineWidth * (mMaxLine == 1 ? 2 : mRealLine);// 计算文字总宽度
