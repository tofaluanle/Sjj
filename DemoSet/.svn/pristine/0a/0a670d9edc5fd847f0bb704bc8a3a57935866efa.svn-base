...
import cn.demoset.R;
import cn.demoset.newsclient.ui.IndicatorFragmentActivity.TabInfo;
...
public class TitleIndicator extends LinearLayout implements
	...
	public TitleIndicator(Context context, AttributeSet attrs) {
		...
		int footerColor = a.getColor(R.styleable.TitleIndicator_footerColor,
				FOOTER_COLOR);
		mTextColor = a
				.getColorStateList(R.styleable.TitleIndicator_t_textColor);
	...
	// 初始化选项卡
	public void init(int startPos, List<TabInfo> tabs,
