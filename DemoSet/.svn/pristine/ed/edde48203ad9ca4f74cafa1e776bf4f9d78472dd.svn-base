 ...
 */
package cn.demoset.scrolltab.ui;
...
import cn.demoset.R;
import cn.demoset.scrolltab.ui.IndicatorFragmentActivity.TabInfo;
...
public class TitleIndicator extends LinearLayout implements View.OnClickListener,
    ...
    public TitleIndicator(Context context, AttributeSet attrs) {
        ...
        mTextColor = a.getColorStateList(R.styleable.TitleIndicator_t_textColor);
