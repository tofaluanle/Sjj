...
package cn.demoset.newsclient.ui;

import cn.demoset.newsclient.BidirSlidingLayout;
...
public class ViewPagerCompat extends ViewPager {
	...
	public boolean onInterceptTouchEvent(MotionEvent event) {
		...
		// System.out.println("page onInterceptTouchEvent: "
	...
	public boolean onTouchEvent(MotionEvent ev) {
		if (null != bsl
				&& !(bsl.isLeftLayoutVisible() || bsl.isRightLayoutVisible())) {
		...
		try {
			...
			// System.out.println("viewpager onTouchEvent: " + onTouchEvent);
			return onTouchEvent;
		} catch (Exception e) {
			return false;
		}
